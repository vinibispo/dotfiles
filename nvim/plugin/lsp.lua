...
local function on_attach(client, buffnr)
  ...
  if client.supports_method('textDocument/codeAction') then
    ...
    table.insert(mappings, { "v", "<leader>ca", function()
  ...
  if client.supports_method('textDocument/formatting') then
    ...
    table.insert(mappings, { "n", "<leader>F", function()
      format_lsp(buffnr)
    end, opts })
  ...
  table.insert(mappings, { "n", "<C-a>", function()
    saga_action.smart_scroll_with_saga(1)
  end, opts })

  table.insert(mappings, { "n", "<C-b>", function()
    saga_action.smart_scroll_with_saga(-1)
  end, opts })
...
local function make_config(client_name)
  ...
  capabilities.textDocument.completion.completionItem.resolveSupport = { properties = { 'documentation', 'detail',
    'additionalTextEdits' } }
